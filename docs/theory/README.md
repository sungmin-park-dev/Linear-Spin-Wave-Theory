...
├── figures/                     # Figures (symlinked to ../Spin_supersolid/Figures/)
...
└── latex_sections/              # Original pandoc-converted files (for reference)
```
...
1. **Original LaTeX**: `docs/Spin_supersolid/note_lswt.tex`
...
- **Original LaTeX**: [`docs/Spin_supersolid/note_lswt.tex`](../Spin_supersolid/note_lswt.tex)
- **Figures**: [`docs/Spin_supersolid/Figures/`](../Spin_supersolid/Figures/)
- **Processing Script**: [`process_sections.py`](process_sections.py)

## 📚 Usage for Developers

When working with the LSWT package:

1. **Reference Implementation**: These documents explain the theoretical foundation for the code in `lswt/solvers/` and `lswt/physics/`
...
1. Check the original LaTeX source: `docs/Spin_supersolid/note_lswt.tex`
